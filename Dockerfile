...
RUN pip3 install numpy scipy six wheel jaxlib==${JAXLIB_VERSION}+cuda11.cudnn805 -f https://storage.googleapis.com/jax-releases/jax_releases.html

# this specific one works. 0.1.6x did not, neither did 0.3. Haven't tried many others.
# RUN pip3 install "jax[cuda112]==0.1.77"
RUN pip3 install "jax[cuda112]==0.3.10"
